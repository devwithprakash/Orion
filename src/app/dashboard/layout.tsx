  ...
  return (
    <div className="h-screen flex bg-background text-foreground overflow-hidden">
      ...
      <main className="flex-1 flex flex-col min-w-0">
        <header className="h-14 px-4 sm:px-6 border-b border-border flex items-center justify-between glass z-10 gap-3">
          <div className="flex items-center gap-3 min-w-0">
            <button
              onClick={() => setOpen(true)}
              className="md:hidden size-9 grid place-items-center rounded-lg hover:bg-secondary -ml-1"
              aria-label="Menu"
            >
